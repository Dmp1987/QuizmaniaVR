...
{
    [SerializeField] private bool presence;    
    [Space]
    //PHysics Move
    ...
    private Rigidbody _rbPresenceClone;
    ...
    void Start()
    {
        ...
        //presence
        _rbPresenceClone = GetComponent<Rigidbody>();
    }
    ...
    private void physicsMove()
    {
        ...
        if (presence && Vector3.Distance(_followTarget.position, transform.position)>0.05f)
        {
        ...
        /*
         if presence && Vector3.Distance(controller.Pos  followTarget.Pos) > 5
         activate presence.mesh
         presence.pos
